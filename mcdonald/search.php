...
?>
	...
	<div class="title animate no_entering_animation has_background" style="background-image:url(/wp-content/uploads/2018/02/header_attorneys.jpg); height:px;">
					...
					case 1: ?>
							<div class="blog_holder">
											...
											<div class="post_text_inner">
												...
												<span class="info">
													 <?php if($blog_hide_comments != "yes"){ ?>
														 <span class="left">
																<a href="<?php the_permalink(); ?>" title="<?php the_title_attribute(); ?>" class="button">Read More</a>
														 </span>
													<?php } ?>
								...
								<?php else: //If no posts are present ?>
									<div class="entry">                        
											<p><?php _e('<h3>No posts were found.</h3><p>Please try your search again.</p>', 'qode'); ?></p>    
									</div>
								<?php endif; ?>
							</div>
					 <?php	break;
								...
								<article <?php post_class(); ?>>
									...
									<div class="post_text_holder">
										<div class="post_text_inner">
											...
											<span class="info">
												<?php if($blog_hide_comments != "yes"){ ?>
													<span class="left"><a href="<?php the_permalink(); ?>" title="<?php the_title_attribute(); ?>" class="button">Read More</a></span>
												<?php } ?>	
